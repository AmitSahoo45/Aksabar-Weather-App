// alert("Recommended:-Open on laptop/desktop for better experience");

//const APP_ID = "__ENTER_YOUR_KEY_HERE__"
const APP_ID = "400fc39cb26f91e4707c1144203007ef"
...
const getLocation = () => {
	if (navigator.geolocation) {
		...
		console.log("We are Sorry. Geolocation is not supported by this browser.")
	}
}
const errorFillup = (data, side) => {
	...
	document.querySelector(`${classSelection}`).insertAdjacentHTML(
		...
		`<div class="error-message">
			...
			<div class="error-message">Please enter correct city name</div>
		</div>`
	)
}
